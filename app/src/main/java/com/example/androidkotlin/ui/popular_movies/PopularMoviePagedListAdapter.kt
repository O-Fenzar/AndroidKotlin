...
class PopularMoviePagedListAdapter( public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    override fun getItemCount(): Int {
        ...
        return super.getItemCount() + if (hasExtraRow()) 1
        else 0
    }
    ...
    class MovieItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Movie?, context: Context) {
            ...
            itemView.movie_title_cv.text = movie?.title
            itemView.movie_release_date_cv.text = movie?.releaseDate

            val moviePosterURL = POSTER_BASE_URL + movie?.posterPath
            Glide.with(itemView.context)
                .load(moviePosterURL)
                .into(itemView.movie_poster_iv_cv);
    ...
    class NetworkStateItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(networkState: NetworkState?) {
            ...
            if (networkState != null && networkState == NetworkState.ERROR) {
                ...
                itemView.error_message_item.text = networkState.message;
